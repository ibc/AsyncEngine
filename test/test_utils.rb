...
class TestUtils < AETest
  ...
  def test_01_ip_type
    ...
    assert_equal :ipv4, AE::Utils.ip_type("1.2.3.04")
    assert_equal :ipv4, AE::Utils.ip_type("1.2.3.004")
    assert_equal false, AE::Utils.ip_type("1.2.3.0004")
    ...
    assert_equal false, AE::Utils.ip_type("1::8::1")
    ...
    assert_equal false, AE::Utils.ip_type("domain.net")
  end

  def test_02_compare_ips
    assert_true AE::Utils.compare_ips("1.2.3.4", "1.2.3.4")
    #assert_true AE::Utils.compare_ips("1.2.3.4", "01.2.3.4")  # TODO: It returns false.
    ...
    assert_nil AE::Utils.compare_ips("[1080::8:800:200C:417A]", "[1080:0:0:0:8:800:200C:417A]")
